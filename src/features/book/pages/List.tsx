...
import { useBooksQuery, useCategoriesQuery, useDeleteBookMutation, useNewBookMutation, useUpdateBookMutation } from '../queries';
    ...
    <div className="min-h-screen p-6 relative overflow-hidden bg-gradient-to-br from-[#08203E] to-[#557C93]">
      ...
      <div className="flex justify-between items-center mb-6 relative z-10">
        ...
        <button
          ...
          className="bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded-xl border border-white/30 transition"
        >
          + Add Book
        </button>
      </div>
